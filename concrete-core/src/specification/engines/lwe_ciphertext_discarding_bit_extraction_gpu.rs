...
engine_error! {
    LweCiphertextDiscardingBitExtractGpuError for LweCiphertextDiscardingBitExtractGpuEngine @
...
impl<EngineError: std::error::Error> LweCiphertextDiscardingBitExtractGpuError<EngineError> {
...
pub trait LweCiphertextDiscardingBitExtractGpuEngine<
    BootstrapKey,
    KeyswitchKey,
    InputCiphertext,
    OutputCiphertextVector,
    ...
    OutputCiphertextVector: LweCiphertextVectorEntity,
{
    ...
    /// of [`LweCiphertextDiscardingBitExtractGpuError`]. For safety concerns _specific_ to an
