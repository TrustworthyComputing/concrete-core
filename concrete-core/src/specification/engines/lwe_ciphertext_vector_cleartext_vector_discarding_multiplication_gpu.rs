...
engine_error! {
    LweCiphertextVectorCleartextVectorDiscardingMultiplicationGpuError for LweCiphertextVectorCleartextVectorDiscardingMultiplicationGpuEngine @
...
impl<EngineError: std::error::Error>
    LweCiphertextVectorCleartextVectorDiscardingMultiplicationGpuError<EngineError>
{
...
pub trait LweCiphertextVectorCleartextVectorDiscardingMultiplicationGpuEngine<
