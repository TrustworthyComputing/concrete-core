...
engine_error! {
    LweCircuitBootstrapPrivateFunctionalPackingKeyswitchKeysConversionGpuError for
...
impl<EngineError: std::error::Error>
    LweCircuitBootstrapPrivateFunctionalPackingKeyswitchKeysConversionGpuError<EngineError>
{
...
///
/// # Formal Definition
pub trait LweCircuitBootstrapPrivateFunctionalPackingKeyswitchKeysConversionGpuEngine<Input, Output>:
    AbstractEngine
where
    ...
    Output: LweCircuitBootstrapPrivateFunctionalPackingKeyswitchKeysEntity,
{
    ...
    fn convert_lwe_circuit_bootstrap_private_functional_packing_keyswitch_keys(
        ...
        Output,
        LweCircuitBootstrapPrivateFunctionalPackingKeyswitchKeysConversionGpuError<
            Self::EngineError,
        >,
    >;
