...
engine_error! {
    LweCiphertextDiscardingBootstrapGpuError for LweCiphertextDiscardingBootstrapGpuEngine @
...
impl<EngineError: std::error::Error> LweCiphertextDiscardingBootstrapGpuError<EngineError> {
...
pub trait LweCiphertextDiscardingBootstrapGpuEngine<
    BootstrapKey,
    Accumulator,
    InputCiphertext,
    OutputCiphertext,
    ...
    OutputCiphertext: LweCiphertextEntity,
{
    ...
    fn discard_bootstrap_lwe_ciphertext(
        ...
        bsk: &BootstrapKey,
        stream_idx: usize,
    ) -> Result<(), LweCiphertextDiscardingBootstrapGpuError<Self::EngineError>>;
