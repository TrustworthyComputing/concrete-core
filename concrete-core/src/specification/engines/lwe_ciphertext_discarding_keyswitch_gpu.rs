...
engine_error! {
    LweCiphertextDiscardingKeyswitchGpuError for LweCiphertextDiscardingKeyswitchGpuEngine @
...
impl<EngineError: std::error::Error> LweCiphertextDiscardingKeyswitchGpuError<EngineError> {
...
pub trait LweCiphertextDiscardingKeyswitchGpuEngine<KeyswitchKey, InputCiphertext, OutputCiphertext>:
    AbstractEngine
where
    KeyswitchKey: LweKeyswitchKeyEntity,
    InputCiphertext: LweCiphertextEntity,
    OutputCiphertext: LweCiphertextEntity,
{
    ...
    fn discard_keyswitch_lwe_ciphertext(
        ...
        ksk: &KeyswitchKey,
        stream_idx: usize,
    ) -> Result<(), LweCiphertextDiscardingKeyswitchGpuError<Self::EngineError>>;
