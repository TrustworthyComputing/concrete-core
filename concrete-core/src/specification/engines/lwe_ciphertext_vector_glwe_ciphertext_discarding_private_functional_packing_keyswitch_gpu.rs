...
engine_error! {
    LweCiphertextVectorGlweCiphertextDiscardingPrivateFunctionalPackingKeyswitchGpuError for
...
/// (pg.10)
pub trait LweCiphertextVectorGlweCiphertextDiscardingPrivateFunctionalPackingKeyswitchGpuEngine<
    LwePrivateFunctionalPackingKeyswitchKey,
    InputCiphertextVector,
    OutputCiphertext,
