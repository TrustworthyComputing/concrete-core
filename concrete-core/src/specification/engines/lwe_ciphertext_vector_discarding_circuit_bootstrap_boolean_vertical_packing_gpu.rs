...
engine_error! {
    LweCiphertextVectorDiscardingCircuitBootstrapBooleanVerticalPackingGpuError for
...
impl<EngineError: std::error::Error>
    LweCiphertextVectorDiscardingCircuitBootstrapBooleanVerticalPackingGpuError<EngineError>
{
...
///
/// # Formal Definition
pub trait LweCiphertextVectorDiscardingCircuitBootstrapBooleanVerticalPackingGpuEngine<
    Input,
    Output,
    BootstrapKey,
    LUTs,
