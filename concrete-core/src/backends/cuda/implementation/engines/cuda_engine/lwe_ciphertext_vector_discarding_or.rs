    ...
    > for CudaEngine
{
    ...
    fn discard_or_lwe_ciphertext_vector(
        ...
        LweCiphertextVectorDiscardingOrError::perform_generic_checks(
            output, input_1, input_2
        )?;
        unsafe { self.discard_or_lwe_ciphertext_vector_unchecked(
                        output, 
                        input_1, 
                        input_2,
                        bsk, 
    ...
    unsafe fn discard_or_lwe_ciphertext_vector_unchecked(
        ...
        self.streams[self.stream_idx].discard_or_amortized_lwe_ciphertext_vector::<u32>(
