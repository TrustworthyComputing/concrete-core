    ...
    > for CudaEngine
{
    ...
    fn discard_and_lwe_ciphertext_vector(
        ...
        LweCiphertextVectorDiscardingAndError::perform_generic_checks(
            output, input_1, input_2
        )?;
        unsafe { self.discard_and_lwe_ciphertext_vector_unchecked(
                        output, 
                        input_1, 
                        input_2,
                        bsk, 
    ...
    unsafe fn discard_and_lwe_ciphertext_vector_unchecked(
        ...
        self.streams[self.stream_idx].discard_and_amortized_lwe_ciphertext_vector::<u32>(
